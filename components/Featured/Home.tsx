...
import { EntityTVorMovie } from '@/types'
...
const FeaturedPoster: FC<FeaturedPosterProps> = ({ lists, id }) => {
  ...
  return (
    <section
      ...
      className='mx-auto lg:w-[min(1440px,88.88888%)]'
    >
      <div
        ref={wrapperRef}
        tabIndex={0}
        ...
        className={[
          'mx-auto max-w-full snap-x snap-mandatory overflow-auto scroll-smooth whitespace-nowrap text-[0] outline-none lg:rounded-lg',
      ...
      >
        {lists.map((list, index) => (
          <Link
            ...
            // className='relative inline-block w-full snap-center overflow-hidden outline-none max-md:h-[177vw] md:h-[max(432px,min(56.25vw,576px))] xl:h-[max(432px,min(56.25vw,593px))]'
            className='relative inline-block w-full snap-center overflow-hidden outline-none max-md:h-[177vw] md:h-auto md:pt-[56.25%] lg:pt-[calc(56.25%_-_100px)]'
          ...
          >
            <div className='absolute bottom-0 left-0 right-0 top-0 text-base'>
              ...
              <div className='absolute bottom-12 left-5 right-5 z-[1] md:bottom-[15%] md:left-[min(max(40px,5.1%))] md:right-[min(max(40px,5.1%))] md:flex md:items-center'>
                <div>
                  <div>
                    <img
                  ...
                  <div className='max-w-[320px] whitespace-normal max-md:mx-auto'>
                    ...
                    <p className='line-clamp-2 text-sm tracking-normal text-white max-md:mx-auto max-md:max-w-[320px] max-md:text-center md:text-base'>
                      {list.overview}
                    </p>
                  </div>
                </div>
      ...
      <div
        ...
        className='absolute bottom-0 left-0 right-0 z-[1] flex justify-center pb-4'
      >
        {lists.map((list, index) => (
          <div
            key={list.id}
