...
import { EntityAll, EntityTVorMovie, HeroMedia } from '@/types/entities'
...
const SectionStage: FC<SectionStageProps> = (props) => {
  return (
    <section className='bg-zinc-900'>
      <div className='flex max-h-[min(calc(100svh_-_0px),950px)] flex-col justify-end max-md:h-[177.777776vw] max-md:min-h-[568px] md:h-[56.25vw]'>
